...
public final class Constants {
	...
	public static int CARET_DIFF_ADJUST_CHANGE_BLOCK = 1080;
	
	public static long CARET_REWARD_RECIPIENT_ASSIGNMENT_START_BLOCK = 1080;
    ...
    public static long CARET_SUBSCRIPTION_START_BLOCK = Integer.MAX_VALUE;
    ...
    public static final int DIGITAL_GOODS_STORE_BLOCK = 1080;
	...
	protected static final int AUTOMATED_TRANSACTION_BLOCK = 1080;
	public static final int AT_BLOCK_PAYLOAD = MAX_PAYLOAD_LENGTH/2;
	public static final int AT_FIX_BLOCK_2 = 1080;
	public static final int AT_FIX_BLOCK_3 = 1080;
    ...
    public static final int EC_CHANGE_BLOCK_1 = 1080;
